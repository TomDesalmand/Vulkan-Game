...
namespace vulkan {
    ...
    void Device::pickPhysicalDevice() {
        ...
        INFO("Physical device: ", _properties.deviceName);
    }
    ...
    Device::~Device() {
        ...
        // Ensure the device is idle before destroying resources to avoid "in use" validation errors
